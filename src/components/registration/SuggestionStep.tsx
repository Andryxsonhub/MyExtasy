// src/components/registration/SuggestionStep.tsx (COM BOTÃO VOLTAR)
...
      </div>
      
      {/* --- MUDANÇA 2: Adicionado um container flex para os botões e o novo botão "Voltar" --- */}
...
          onClick={handleNextClick}
          size="lg"
          className="w-full" // A estilização foi movida para o componente Button
        >
          Adicionar e avançar
        </Button>
      </div>
