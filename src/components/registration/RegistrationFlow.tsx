// src/components/registration/RegistrationFlow.tsx (VERSÃO COMPLETA E CORRIGIDA)
...
      const response = await axios.post('https://myextasyclub-backend.onrender.com/api/users/register', userData);
      // ===================================
