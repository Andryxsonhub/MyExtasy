// src/components/Footer.tsx (Versão correta para Vite + React Router DOM)

import React from 'react';
// Importando o Link da biblioteca correta: react-router-dom
    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row justify-between items-center text-center md:text-left">
          ...
          {/* Links de Navegação - agora usando o <Link> do react-router-dom com a propriedade "to" */}
          ...
          <div className="flex space-x-4">
            {/* Links externos (<a>) para redes sociais não mudam */}
